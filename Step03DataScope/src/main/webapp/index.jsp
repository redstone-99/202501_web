...
<body>
	<div class="container">
		<h1>인덱스 페이지 입니다.</h1>
		<ul>
			<li><a href="${pageContext.request.contextPath }/fourtune">오늘의 운세</a></li>
			...
			<li><a href="${pageContext.request.contextPath }/test/fortune.jsp">서블릿 안 거쳐서 안 나온다.</a></li>
		</ul>
		
		<form action="${pageContext.request.contextPath }/test/save.jsp" method="post">
			<input type="text" name="nick" placeholder="닉네임 입력..." />
			<button type="sumbit">닉네임 기억 시키기</button>
		</form>
